...
public class MedicineDataHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE Medicine(id integer primary key autoincrement, name varchar(30), speci varchar(4), shape integer, color integer, dosage varchar(20),syear varchar(6),smonth varchar(3), sday varchar(3), eyear varchar(6), emonth varchar(3), eday varchar(3), frequency varchar(3), specialill varchar(200) );");
