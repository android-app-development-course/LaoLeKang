...
public class Medicine implements Parcelable {
    ...
    public Medicine(String name,String speci,int shape,int color,String dosage,String syear,String smonth,String sday,String eyear,String emonth,String eday,String fre,List<detialFrequency> mdetialFrequency,String specialIllustration)
    {
        mName=name;
        mShape=shape;
        mSpeci=speci;
    ...
    public static final Parcelable.Creator<Medicine> CREATOR = new Parcelable.Creator<Medicine>() {
        ...
        public Medicine createFromParcel(Parcel source) {
            //从Parcel中读取数据
            //此处read顺序依据write顺序
            return new Medicine(source.readString(),source.readString(), source.readInt(),source.readInt(),source.readString(),source.readString(),source.readString(),source.readString(),source.readString(),source.readString(),source.readString(),source.readString(),(List<detialFrequency>)source.readArrayList(detialFrequency.class.getClassLoader()),source.readString());
        }
        @Override
